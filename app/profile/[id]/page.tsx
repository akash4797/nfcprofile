...
import SaveContact from "./SaveProfile";
        ...
        <div className=" bg-black w-full rounded-lg shadow-lg">
          <div className="relative h-[300px]">
            ...
            <Image
              ...
              width={1200}
              height={1200}
              className="w-full h-[300px] object-cover rounded-t-lg object-center"
            />
          </div>
        ...
        <div className="z-50 mt-2">
          {userProfile && (
            <SaveContact
              ...
              userImage={urlFor(userProfile?.user.image)}
            />
          )}
        </div>
      </div>
